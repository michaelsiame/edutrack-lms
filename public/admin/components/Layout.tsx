    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="bg-white border-b border-gray-200 h-16 px-6 flex items-center justify-between shadow-sm z-10">
           <div className="flex items-center">
              <button className="md:hidden mr-4" onClick={() => setMobileOpen(!isMobileOpen)}>
                <Icons.Home /> {/* Placeholder for hamburger */}
              </button>
              <h2 className="text-lg font-semibold text-gray-700 hidden md:block capitalize">{currentView}</h2>
           </div>
