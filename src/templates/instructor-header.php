...
<div x-data="{ sidebarOpen: false }" class="flex h-screen overflow-hidden">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" 
        ...
        <nav class="px-2 py-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?= url('instructor/discussions.php') ?>" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-gray-800">
                <i class="fas fa-comments w-6"></i><span>Discussions</span>
            </a>
