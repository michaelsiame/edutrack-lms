...
/**
 * Displays a TEVETA verification badge based on the configuration.
 * Uses constants defined in config.php (TEVETA_VERIFIED, TEVETA_CODE).
 */
function teveta_badge() {
    // Check if the TEVETA integration is enabled and verified in the config
    if (defined('TEVETA_VERIFIED') && TEVETA_VERIFIED) {
        // If verified, display a green "Verified" badge with the code
        echo '<a href="https://www.teveta.org.zm" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-3 py-1 bg-green-100 text-green-800 text-sm font-semibold rounded-full hover:bg-green-200 transition">';
        echo '  <i class="fas fa-check-circle mr-2"></i>';
        echo '  TEVETA Verified (' . sanitize(TEVETA_CODE) . ')';
        echo '</a>';
    } else {
        // If not verified, display a yellow "Pending" badge
        echo '<span class="inline-flex items-center px-3 py-1 bg-yellow-100 text-yellow-800 text-sm font-semibold rounded-full">';
        echo '  <i class="fas fa-hourglass-half mr-2"></i>';
        echo '  TEVETA Verification Pending';
        echo '</span>';
    }
}
/**
 * Display a styled success alert.
 *
 * @param string $message The message to display.
 */
function successAlert($message) {
    echo '<div class="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-4 rounded-md" role="alert">';
...
/**
 * Display a styled error alert.
 *
 * @param string $message The message to display.
 */
function errorAlert($message) {
    echo '<div class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4 rounded-md" role="alert">';
