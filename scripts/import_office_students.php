...
foreach ($students as $student) {
    ...
    if (!empty($lessons)) {
        ...
        foreach ($lessons as $lesson) {
            ...
            if (!$existing) {
                ...
                $db->query("INSERT INTO lesson_progress ($colStr) VALUES ($valStr)", $params);
            }
        }
        echo "    - Marked " . count($lessons) . " lessons complete\n";
    }
    ...
    echo "    - Recorded " . count($student['grades']) . " assignment grades\n";
