...
<div class="min-h-screen bg-gray-50 py-12">
 ...
 <div class="p-6">
 @if(session('info'))
 <div class="mb-4 p-4 bg-primary-50 border border-primary-200 rounded-lg text-primary-700">
 {{ session('info') }}
 </div>
 @endif

 @if(session('error'))
 <div class="mb-4 p-4 bg-danger-50 border border-danger-200 rounded-lg text-danger-700">
 {{ session('error') }}
 </div>
 @endif
 ...
 <div class="ml-3 flex-1">
 <div class="flex items-center">
 <i class="fas fa-mobile-alt text-success-600 mr-2"></i>
 ...
 <span class="font-medium text-success-600">K{{ number_format($totalPaid, 2) }}</span>
 </div>
 ...
 <i class="fas fa-info-circle text-warning-500 mt-0.5 mr-2"></i>
