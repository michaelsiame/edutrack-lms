...
<section class="py-16 bg-white">
 ...
 <!-- Mission -->
 <div class="bg-primary-50 rounded-xl p-8 shadow-lg animate-slide-up">
 <div class="w-20 h-20 bg-primary-600 rounded-full flex items-center justify-center mb-6 shadow-lg">
 ...
 <!-- Vision -->
 <div class="bg-primary-50 rounded-xl p-8 shadow-lg animate-slide-up animation-delay-200">
 <div class="w-20 h-20 bg-primary-600 rounded-full flex items-center justify-center mb-6 shadow-lg">
...
<section class="py-20 bg-gray-50">
 ...
 <i class="fas fa-certificate text-secondary-600 text-2xl"></i>
 </div>
 ...
 <i class="fas fa-laptop-code text-primary-600 text-2xl"></i>
 </div>
 ...
 <div class="w-14 h-14 bg-secondary-100 rounded-xl flex items-center justify-center mb-6">
 <i class="fas fa-briefcase text-secondary-600 text-2xl"></i>
 </div>
 ...
 <div class="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 animate-slide-up">
 <div class="w-14 h-14 bg-primary-100 rounded-xl flex items-center justify-center mb-6">
 <i class="fas fa-chalkboard-teacher text-primary-600 text-2xl"></i>
 </div>
 ...
 <i class="fas fa-users text-danger-600 text-2xl"></i>
 </div>
...
<section class="py-16 bg-primary-600 text-white">
 ...
 <a href="{{ route('courses.index') }}" class="inline-flex items-center justify-center px-8 py-4 bg-secondary-500 text-gray-900 font-semibold rounded-lg hover:bg-secondary-600 transition shadow-lg">
