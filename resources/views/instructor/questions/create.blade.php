...
<div class="max-w-3xl mx-auto">
    ...
    <form action="{{ route('instructor.quizzes.questions.store', $quiz) }}" method="POST" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-6 space-y-6" x-data="questionForm()" x-init="init()">
        @csrf
