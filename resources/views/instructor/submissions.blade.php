...
<div class="space-y-6" x-data="{ tab: 'assignments' }">
    {{-- Tab Switcher --}}
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-1 flex gap-1">
                ...
                <table class="dashboard-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-sm text-gray-500 dark:text-gray-400">{{ $submission->submitted_at?->diffForHumans() ?? 'N/A' }}</td>
                            <td>
                ...
                <table class="dashboard-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-sm text-gray-500 dark:text-gray-400">{{ $attempt->completed_at?->diffForHumans() ?? ($attempt->submitted_at?->diffForHumans() ?? 'N/A') }}</td>
