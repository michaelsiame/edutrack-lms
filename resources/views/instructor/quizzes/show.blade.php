    ...
    <div class="od-card p-6">
        <div class="flex items-start justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <form action="{{ route('instructor.quizzes.destroy', $quiz) }}" method="POST" class="inline" data-confirm="Delete this quiz?">
                    @csrf
                    @method('DELETE')
    ...
    <div class="od-card" style="padding: 0; overflow: hidden;">
        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <span class="od-meta">{{ $quiz->questions->count() }} total</span>
                    ...
                    <div class="flex-1">
                        <div class="flex items-start justify-between gap-3">
                            ...
                            <div class="flex items-center gap-1 flex-shrink-0">
                                ...
                                <form action="{{ route('instructor.quizzes.questions.destroy', [$quiz, $question]) }}" method="POST" class="inline" data-confirm="Delete this question?">
                                    @csrf
                                    @method('DELETE')
