...
<div class="min-h-screen bg-gray-50 flex items-center justify-center py-12 px-4">
 ...
 <div class="mb-6">
 <div class="mx-auto w-20 h-20 bg-danger-100 rounded-full flex items-center justify-center">
 <i class="fas fa-times text-4xl text-danger-600"></i>
 </div>
 </div>
 ...
 <p class="text-sm text-gray-500 mb-4">Your enrollment is still active. Please try the payment again.</p>
 ...
 <div class="space-y-3">
 <a href="{{ route('student.payments') }}" class="block text-primary-600 hover:text-primary-700 font-medium">
