...
<section class="relative text-white overflow-hidden" style="min-height: 600px;">
 ...
 <span class="inline-flex items-center px-5 py-2.5 rounded-full text-sm font-bold bg-secondary-400 text-white shadow-lg border-2 border-secondary-300">
 ...
 <span class="block text-secondary-400 mt-2">Edutrack Computer Training College</span>
 </h1>
 <p class="text-lg md:text-xl lg:text-2xl text-primary-100 mb-10 max-w-3xl mx-auto leading-relaxed">
 ...
 @else
 <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-4 border-2 border-secondary-300 text-base font-medium rounded-xl text-white bg-secondary-400 hover:bg-secondary-500 transition duration-200 shadow-xl transform hover:-translate-y-1">
 ...
 <div class="w-14 h-14 mx-auto mb-3 bg-secondary-400/20 rounded-xl flex items-center justify-center">
 <i class="fas fa-certificate text-2xl text-secondary-400"></i>
 </div>
 <h3 class="text-base md:text-lg font-bold text-white">Registered Institution</h3>
 <p class="text-xs text-primary-200 mt-1">Government Certified</p>
 </div>
 ...
 <div class="w-14 h-14 mx-auto mb-3 bg-primary-500/20 rounded-xl flex items-center justify-center">
 ...
 <p class="text-xs text-primary-200 mt-1">Nationwide Community</p>
 </div>
 ...
 <div class="w-14 h-14 mx-auto mb-3 bg-secondary-400/20 rounded-xl flex items-center justify-center">
 <i class="fas fa-graduation-cap text-2xl text-secondary-300"></i>
 </div>
 <h3 class="text-base md:text-lg font-bold text-white">Expert Instructors</h3>
 <p class="text-xs text-primary-200 mt-1">Industry Professionals</p>
 </div>
 ...
 <div class="w-14 h-14 mx-auto mb-3 bg-primary-400/20 rounded-xl flex items-center justify-center">
 <i class="fas fa-award text-2xl text-primary-300"></i>
 </div>
 <h3 class="text-base md:text-lg font-bold text-white">Career Ready</h3>
 <p class="text-xs text-primary-200 mt-1">Job Placement Support</p>
 </div>
 </div>
 </div>
 </div>
...
<section class="py-20 bg-gray-50">
 ...
 @php $firstCourse = $categoryCourses->first(); $color = $firstCourse->category->color ??'primary'; @endphp
 <!-- Category Header -->
 ...
 $courseColor = $course->category->color ??'primary';
 @endphp
...
<section class="py-20 bg-white">
 ...
 <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-secondary-100 text-secondary-800 shadow-sm">
...
<section class="py-6 bg-secondary-500 text-white">
 ...
 @endif
 <a href="{{ route('courses.index') }}" class="px-8 py-3 bg-white text-secondary-600 rounded-lg font-bold hover:bg-gray-100 transition shadow-lg">
...
<section class="py-20 bg-gray-50">
 ...
 <div class="w-20 h-20 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
 ...
 <div class="w-20 h-20 bg-secondary-100 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
 <i class="fas fa-laptop-code text-secondary-600 text-3xl"></i>
 </div>
 ...
 <div class="w-20 h-20 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
 <i class="fas fa-chalkboard-teacher text-primary-600 text-3xl"></i>
 </div>
