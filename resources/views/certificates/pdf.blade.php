...
<!-- Page frame: gold outer border, navy inner border, white content area -->
<div style="width: 210mm; height: 297mm; background-color: #D4952A; padding: 2mm; box-sizing: border-box;">
  <div style="width: 100%; height: 100%; background-color: #1B3A6B; padding: 2mm; box-sizing: border-box;">
    <div style="width: 100%; height: 100%; background-color: #ffffff; padding: 5mm 10mm 6mm 10mm; box-sizing: border-box;">
      ...
      <!-- Bottom content: pushed down with margin-top -->
      <div style="margin-top: 90mm;">
