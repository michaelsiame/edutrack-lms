...
<link rel="stylesheet" href="file://{{ public_path('assets/css/cert-fonts.css') }}">
<style>
...
<div class="cert-sheet">
  ...
  <div class="content">
    <div class="logos-row">
      <img src="file://{{ public_path('assets/images/logo-sm.png') }}" alt="EduTrack Logo" class="logo-edutrack">
      <img src="file://{{ public_path('assets/images/teveta-logo.png') }}" alt="TEVETA Logo" class="logo-teveta">
    </div>
