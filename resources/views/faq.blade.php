...
<section class="py-16 bg-primary-600 text-white">
 ...
 <a href="https://chat.whatsapp.com/HkqCis0yejbJybxyTbsG2e" target="_blank" class="inline-flex items-center justify-center px-8 py-4 bg-success-500 text-white font-semibold rounded-lg hover:bg-success-600 transition shadow-lg">
