...
<div class="py-12 bg-gray-50">
 ...
 <span class="inline-block px-3 py-1 text-xs font-semibold text-white bg-primary-600 rounded-full mb-2">{{ $course->level }}</span>
 ...
 <span class="ml-2 text-xs text-success-600">(Preview)</span>
 @endif
 </li>
 @endforeach
 </ul>
 ...
 @for($i = 1; $i <= 5; $i++)
 <i class="fas fa-star text-xs {{ $i <= $review->rating ?'text-secondary-400' :'text-gray-300' }}"></i>
 @endfor
 </div>
 </div>
 ...
 <i class="fas fa-star text-xl peer-checked:text-secondary-400 text-gray-300 hover:text-secondary-300 transition-colors"></i>
 </label>
 @endfor
 </div>
 @error('rating')
 ...
 <a href="{{ route('enrollments.show', $course) }}" class="block w-full text-center py-3 px-4 bg-success-600 text-white rounded-md hover:bg-success-700 font-medium">
 <i class="fas fa-play mr-2"></i>Continue Learning
 </a>
 @else
 <a href="{{ route('checkout.show', $course) }}" class="block w-full text-center py-3 px-4 bg-secondary-600 text-white rounded-md hover:bg-secondary-700 font-medium">
 ...
 @csrf
 <button type="submit" class="block w-full text-center py-3 px-4 bg-primary-600 text-white rounded-md hover:bg-primary-700 font-medium">
 ...
 @endif
 @else
 <a href="{{ route('login') }}" class="block w-full text-center py-3 px-4 bg-primary-600 text-white rounded-md hover:bg-primary-700 font-medium">
