...
<div class="py-12 bg-gray-50">
 ...
 <div>
 <select name="level" class="px-4 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500">
 ...
 <button type="submit" class="px-6 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">Filter</button>
 </form>
 </div>
 ...
 <span class="text-xs font-medium text-primary-600 bg-primary-50 px-2 py-1 rounded">{{ $course->category?->name ??'General' }}</span>
