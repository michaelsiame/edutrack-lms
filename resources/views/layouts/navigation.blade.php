...
<nav class="bg-white shadow-md sticky top-0 z-50" x-data="{ mobileMenuOpen: false, moreOpen: false }">
 ...
 @php
 $roleIcon = match($role) {'admin' =>'fa-shield-alt','instructor' =>'fa-chalkboard-teacher','student' =>'fa-user-graduate','finance' =>'fa-money-bill-wave',
 default =>'fa-user'
 };
 $roleColor = match($role) {'admin' =>'text-danger-600','instructor' =>'text-primary-600','student' =>'text-success-600','finance' =>'text-secondary-600',
 ...
 @csrf
 <button type="submit" class="block w-full text-left px-4 py-2 text-sm text-danger-600 hover:bg-gray-50">
 ...
 <form method="POST" action="{{ route('logout') }}" class="m-0">
 @csrf
 <button type="submit" class="block w-full text-left px-3 py-2.5 rounded-lg text-base font-medium text-danger-600 hover:bg-gray-50">
