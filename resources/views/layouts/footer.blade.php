...
<footer class="bg-gray-900 text-gray-300 mt-20">
 ...
 <p class="text-sm text-success-400 mt-2 hidden newsletter-msg" id="newsletter-success">Thank you for subscribing!</p>
 <p class="text-sm text-danger-400 mt-2 hidden newsletter-msg" id="newsletter-error">Something went wrong. Please try again.</p>
 </div>
 </div>
 </div>
