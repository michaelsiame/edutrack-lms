@props(['icon','title','description' => null,'actionText' => null,'actionHref' => null,'actionRoute' => null, 'variant' => 'default'])
...
<div class="od-empty">
    ...
    @if($actionText && ($actionHref || $actionRoute))
        <a href="{{ $actionHref ?? route($actionRoute) }}" class="od-btn od-btn-primary">
