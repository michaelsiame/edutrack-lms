...
<div class="container mx-auto px-4 py-6">
 ...
 <i class="fas fa-clock text-secondary-600 text-xl"></i>
 </div>
 </div>
 </div>
 ...
 <p class="text-2xl font-bold text-danger-600">{{ $overdueCount ?? 0 }}</p>
 </div>
 ...
 <a href="{{ route('finance.payments') }}" class="text-primary-600 hover:text-primary-800 text-sm">View All</a>
 </div>
