...
<div class="max-w-4xl mx-auto px-4 py-12">
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-8 md:p-12">
        ...
        <div class="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300">
            <p class="lead">Welcome to Edutrack Computer Training College. By accessing or using our learning management system, you agree to be bound by these Terms of Service.</p>

            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">1. Acceptance of Terms</h2>
            <p>By registering for an account, enrolling in a course, or using any part of the Edutrack LMS platform, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service and our Privacy Policy.</p>

            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">2. Eligibility</h2>
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">3. Course Enrollment & Payments</h2>
            <p>All course fees are quoted in Zambian Kwacha (ZMW). Payment terms are as follows:</p>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">4. Refund Policy</h2>
            <p>Refund requests are subject to the following conditions:</p>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">5. Intellectual Property</h2>
            <p>All course content, including videos, documents, quizzes, and assignments, is the intellectual property of Edutrack Computer Training College or its licensed partners. You may not:</p>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">6. Certificates</h2>
            <p>Certificates are issued under the following conditions:</p>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">7. Code of Conduct</h2>
            <p>All users must conduct themselves professionally. Prohibited behavior includes:</p>
            <ul class="list-disc pl-6 space-y-2">
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">8. Account Suspension & Termination</h2>
            <p>Edutrack reserves the right to suspend or terminate accounts that violate these terms. In cases of termination for cause, no refund will be issued.</p>

            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">9. Changes to Terms</h2>
            ...
            <h2 class="text-xl font-semibold text-gray-900 dark:text-white mt-8 mb-3">10. Contact</h2>
