<style>
    body { font-family: 'DejaVu Serif', serif; font-size: 11pt; line-height: 1.6; color: #333; }
    h1 { font-size: 18pt; font-weight: bold; color: #1a1a1a; margin-bottom: 6pt; border-bottom: 2pt solid #2563eb; padding-bottom: 6pt; }
    h2 { font-size: 14pt; font-weight: bold; color: #333; margin-top: 14pt; margin-bottom: 6pt; }
    h3 { font-size: 12pt; font-weight: bold; color: #444; margin-top: 10pt; margin-bottom: 4pt; }
    p { margin-bottom: 8pt; }
    ...
    blockquote { border-left: 3pt solid #e5e7eb; padding-left: 10pt; margin-left: 0; font-style: italic; color: #666; }
    ...
    .header-logo { font-size: 10pt; color: #666; margin-bottom: 4pt; }
    .course-meta { font-size: 9pt; color: #666; margin-bottom: 16pt; }
