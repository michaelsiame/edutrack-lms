...
<div class="max-w-4xl mx-auto">
 ...
 <span class="text-xs bg-warning-100 text-warning-800 px-1.5 py-0.5 rounded font-medium"><i class="fas fa-thumbtack mr-1"></i>Pinned</span>
 @endif
 @if($discussion->is_locked)
 <span class="text-xs bg-danger-100 text-danger-800 px-1.5 py-0.5 rounded font-medium"><i class="fas fa-lock mr-1"></i>Locked</span>
 @endif
