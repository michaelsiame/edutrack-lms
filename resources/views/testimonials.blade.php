...
<section class="py-16 bg-primary-600 text-white">
 ...
 <a href="{{ route('courses.index') }}" class="inline-flex items-center justify-center px-8 py-4 bg-secondary-500 text-gray-900 font-semibold rounded-lg hover:bg-secondary-600 transition shadow-lg transform hover:-translate-y-1">
