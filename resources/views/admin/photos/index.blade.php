                ...
                <div class="p-3">
                    ...
                    <div class="flex items-center gap-2 mt-2">
                        @if($photo->is_featured)
                            <span class="text-xs bg-amber-100 text-amber-800 px-1.5 py-0.5 rounded">Featured</span>
                        @endif
                        @if(!$photo->is_active)
                    ...
                    <form action="{{ route('admin.photos.update', $photo) }}" method="POST" class="mt-2 space-y-2">
                        ...
                        <div class="flex gap-2">
                            ...
                            <form action="{{ route('admin.photos.destroy', $photo) }}" method="POST" class="inline" onsubmit="return confirm('Delete this photo?')">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="py-1 px-2 bg-red-600 text-white text-xs rounded hover:bg-red-700">
