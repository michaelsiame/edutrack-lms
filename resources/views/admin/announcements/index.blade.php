...
<div class="max-w-6xl mx-auto">
 ...
 {{ $announcement->priority ==='urgent' ?'bg-danger-100 text-danger-800' : ($announcement->priority ==='high' ?'bg-warning-100 text-warning-800' :'bg-gray-100 text-gray-800') }}">
 {{ $announcement->priority }}
 </span>
 </td>
 <td class="px-4 py-3">
 <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
 {{ $announcement->is_published ?'bg-success-100 text-success-800' :'bg-gray-100 text-gray-800' }}">
