...
<div class="max-w-3xl mx-auto">
 ...
 class="rich-editor w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 dark:bg-gray-700 dark:text-white">{{ old('content', $announcement->content) }}</textarea>
 </div>
