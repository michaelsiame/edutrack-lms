...
<div class="max-w-3xl mx-auto">
 ...
 <option value="{{ $role->id }}" {{ old('role_id', $user->roles->first()?->role_id) == $role->id ? 'selected' : '' }}>{{ $role->role_name }}</option>
 @endforeach
 </select>
 </div>
 </div>
 ...
 <button type="submit" class="px-4 py-2 od-btn od-btn-primary text-sm">Update User</button>
