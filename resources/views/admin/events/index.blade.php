...
<div class="max-w-6xl mx-auto">
 ...
 {{ $event->status ==='upcoming' ?'bg-success-100 text-success-800' : ($event->status ==='cancelled' ?'bg-danger-100 text-danger-800' :'bg-primary-100 text-primary-800') }}">
 {{ ucfirst($event->status) }}
 </span>
 @if($event->is_featured)
 <span class="ml-1 text-xs bg-warning-100 text-warning-800 px-1.5 py-0.5 rounded">Featured</span>
 @endif
 </td>
