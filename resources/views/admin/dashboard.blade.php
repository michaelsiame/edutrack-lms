...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
 ...
 <p class="od-stat-value">{{ number_format($stats['total_users']) }}</p>
 <div class="mt-3 flex items-center text-xs">
 <span class="font-medium" style="color: var(--od-green);"><i class="fas fa-arrow-up mr-1"></i>Active</span>
 <span class="ml-2 od-meta">All roles</span>
 </div>
 </div>
 ...
 <p class="od-stat-value">{{ number_format($stats['total_courses']) }}</p>
 <div class="mt-3 flex items-center text-xs">
 <span class="font-medium" style="color: var(--od-green);"><i class="fas fa-check mr-1"></i>Published</span>
 <span class="ml-2 od-meta">Across categories</span>
 </div>
 </div>
 ...
 <p class="od-stat-value">{{ number_format($stats['total_enrollments']) }}</p>
 <div class="mt-3 flex items-center text-xs">
 <span class="font-medium" style="color: var(--od-navy);"><i class="fas fa-chart-line mr-1"></i>Growing</span>
 <span class="ml-2 od-meta">This year</span>
 </div>
 </div>
 ...
 <div class="mt-3 flex items-center text-xs">
 <span class="font-medium" style="color: var(--od-accent);"><i class="fas fa-clock mr-1"></i>{{ $stats['pending_payments'] }} Pending</span>
 </div>
 </div>
...
<div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
 ...
 <a href="{{ route('admin.enrollments.index') }}" class="text-sm font-medium" style="color: var(--od-navy);">View All</a>
 </div>
 ...
 <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm" style="background: var(--od-navy-soft); color: var(--od-navy);">
 ...
 @empty
 <div class="px-6 py-8 text-center text-sm od-meta">
 <i class="fas fa-inbox text-3xl mb-2" style="color: var(--od-border);"></i>
 ...
 <a href="{{ route('admin.payments.index') }}" class="text-sm font-medium" style="color: var(--od-navy);">View All</a>
 </div>
 <div class="divide-y" style="border-color: var(--od-border);">
 @forelse($stats['recent_payments'] as $payment)
 <div class="px-6 py-4 flex items-center justify-between hover:bg-gray-50/50 transition-colors">
 <div class="flex items-center gap-3">
 <div class="w-9 h-9 rounded-full flex items-center justify-center" style="background: var(--od-green-soft); color: var(--od-green);">
