...
<div class="min-h-screen bg-gray-50 py-12">
 ...
 @if(session('warning'))
 <div class="mb-6 p-4 bg-warning-50 border border-warning-200 rounded-lg text-warning-700">
 {{ session('warning') }}
 </div>
 @endif
 ...
 <i class="fas fa-university text-primary-600 mb-1"></i>
 ...
 <i class="fas fa-exchange-alt text-success-600 mb-1"></i>
 ...
 <i class="fas fa-mobile-alt text-primary-600 mb-1"></i>
