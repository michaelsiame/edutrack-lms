...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('instructor.quizzes.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 text-sm font-medium space-x-2">
                        <a href="{{ route('instructor.quizzes.show', $quiz) }}" class="text-blue-600 hover:text-blue-900">View</a>
                        <a href="{{ route('instructor.quizzes.edit', $quiz) }}" class="text-yellow-600 hover:text-yellow-900">Edit</a>
                    </td>
                </tr>
                @empty
                <tr>
