        ...
        <div class="bg-white py-8 px-4 shadow rounded-xl sm:px-10">
            ...
            @if(session('verification_link'))
                <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <p class="text-sm text-blue-800 font-medium mb-2">Development Mode - Verification Link:</p>
                    <a href="{{ session('verification_link') }}" class="text-sm text-blue-600 break-all hover:underline">
