...
<div class="max-w-4xl mx-auto">
            ...
            <div class="flex-1">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    @if($discussion->creator->isInstructor())
                        <span class="text-xs bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded">Instructor</span>
                    @endif
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                @if($reply->is_best_answer)
                                    <span class="text-xs bg-green-100 text-green-800 px-1.5 py-0.5 rounded"><i class="fas fa-check mr-1"></i>Best Answer</span>
                                @endif
                                ...
                                <div class="mt-3 ml-8 pl-4 border-l-2 border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        @if($childReply->is_instructor_reply)
                                            <span class="text-xs bg-blue-100 text-blue-800 px-1 py-0.5 rounded">Instructor</span>
                                        @endif
    ...
    @else
        <div class="bg-red-50 border border-red-200 rounded-xl p-6 text-center">
            ...
            <p class="text-red-700 font-medium">This discussion is locked. No new replies can be posted.</p>
        </div>
    @endif
</div>
