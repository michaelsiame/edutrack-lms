                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900">{{ $stats['total_enrollments'] }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-4">
                        @forelse($stats['recent_enrollments'] as $enrollment)
                            <div class="flex items-center justify-between py-3 border-b border-gray-200 last:border-0">
                                <div>
                                    <p class="text-sm font-medium text-gray-900">{{ $enrollment->user?->full_name ?? 'Unknown' }}</p>
                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-4">
                        @forelse($stats['recent_payments'] as $payment)
                            <div class="flex items-center justify-between py-3 border-b border-gray-200 last:border-0">
                                <div>
                                    <p class="text-sm font-medium text-gray-900">{{ $payment->student?->full_name ?? 'Unknown' }}</p>
                                    <p class="text-xs text-gray-500">ZMW {{ number_format($payment->amount, 2) }}</p>
                                </div>
