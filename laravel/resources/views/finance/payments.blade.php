    ...
    <div class="bg-white rounded-lg shadow p-4 mb-6">
        <form action="{{ route('finance.payments') }}" method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div>
                ...
                <input type="date" name="from" value="{{ request('from') }}" class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
            <div>
                <label class="block text-sm font-medium text-gray-700">Date To</label>
                <input type="date" name="to" value="{{ request('to') }}" class="mt-1 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
            </div>
